 ...
 */
package org.b2bstore.test.setup;
...
import org.b2bstore.test.constants.B2bstoreTestConstants;
import org.b2bstore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = B2bstoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/b2bstoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/b2bstoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/b2bstoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/b2bstoretest/import/csquotes.impex");
		}
	}
}
