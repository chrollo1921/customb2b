 ...
 */
package org.b2bstore.core.constants;

/**
 * Global class for all B2bstoreCore constants. You can add global constants for your extension into this class.
 */
public final class B2bstoreCoreConstants extends GeneratedB2bstoreCoreConstants
{
	public static final String EXTENSIONNAME = "b2bstorecore";


	private B2bstoreCoreConstants()
	{
		//empty
	}
