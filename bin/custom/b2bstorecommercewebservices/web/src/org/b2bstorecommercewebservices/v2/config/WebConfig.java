 ...
 */
package org.b2bstorecommercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import org.b2bstorecommercewebservices.constants.YcommercewebservicesConstants;
import org.b2bstorecommercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "b2bstorecommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "b2bstorecommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "b2bstorecommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "b2bstorecommercewebservices.v2.description";
	private static final String TITLE = "b2bstorecommercewebservices.v2.title";
	private static final String VERSION = "b2bstorecommercewebservices.v2.version";
	private static final String LICENSE = "b2bstorecommercewebservices.v2.license";
	private static final String LICENSE_URL = "b2bstorecommercewebservices.v2.license.url";
